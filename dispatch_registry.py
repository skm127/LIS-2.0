"""
LIS Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so LIS always knows what he's working on,
...
log = logging.getLogger("LIS.dispatch")
