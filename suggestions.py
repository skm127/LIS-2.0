"""
LIS Proactive Suggestions — Contextual follow-up suggestions after task completion.
...
log = logging.getLogger("LIS.suggestions")
...
class Suggestion:
    ...
    text: str  # Voice-friendly suggestion (LIS personality)
